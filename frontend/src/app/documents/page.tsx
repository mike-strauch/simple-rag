...
const DocumentList = () => {
  ...
  return <div className="w-[60%] flex flex-col gap-2 items-center">
    <legend className="self-start font-semibold">All Documents</legend>
    <div className="w-full max-h-96 overflow-auto border border-purple-200">
    ...
    <fieldset className="flex w-full flex-col items-center justify-center">
      <div className="flex h-[30%] w-[60%] flex-col gap-2">
        <div className="flex items-center w-full">
          <label htmlFor="contentText" className="hidden">Enter Content to Index</label>
        ...
        <textarea
          ...
          className="min-h-48 rounded-md border border-gray-500 p-2 focus:outline-1 focus:outline-gray-400"
        ></textarea>
      </div>
    </fieldset>
  </form>;
