...
export default function DocumentView() {
  ...
  return (
    <div className="flex min-h-screen flex-col items-center gap-4 overflow-auto p-12">
      <Link href="/documents" className="pl-2 hover:text-purple-200">
        &lt; Back
      </Link>
      <div className="flex min-h-[30%] w-[40%] min-w-96 flex-col gap-2 border border-gray-300 p-6">
